...
public class Product2 extends Object implements Comparable<Product2>{
	private String name;
	private int su, buyprice, selprice, transport, money;
	private double rate;
	
	public Product2(String name, int su, int selprice, int buyprice, int transport) {	// Constructor
		this.name = name;
		this.su = su;
